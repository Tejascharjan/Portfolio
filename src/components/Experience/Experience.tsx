...
const Experience = () => {
     return (
          <section
               id='experience'
               className='py-24 pb-24 px-[12vw] md:px-[7vw] xl:px-[16vw] font-sans skills-gradient clip-path-custom-2'
          >
               {/* section title */}
               <div className='text-center mb-16'>
                    <h2 className='text-4xl font-bold text-white uppercase'>Experience</h2>
